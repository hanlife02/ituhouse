...
const translations = {
  zh: {
    ...
    insertImageUrl: "使用图片链接",
    uploadingImage: "图片上传中...",
    imageUploadFailed: "图片上传失败，请稍后再试",
    imageUrlPrompt: "请输入图片链接（可选）",
    imageUrlRequired: "请输入有效的图片链接",
    cancel: "取消",
    publish: "发布",
    publishing: "发布中...",
    comment: "发表评论...",
  ...
  en: {
    ...
    insertImageUrl: "Use image URL",
    uploadingImage: "Uploading image...",
    imageUploadFailed: "Failed to upload image. Please try again later.",
    imageUrlPrompt: "Enter an image URL (optional)",
    imageUrlRequired: "Please provide a valid image URL",
    cancel: "Cancel",
    publish: "Publish",
